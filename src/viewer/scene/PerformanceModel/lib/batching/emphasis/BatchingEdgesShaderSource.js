...
function buildVertex(scene) {
    ...
    // flags.z = NOT_RENDERED | OPAQUE_EDGES | TRANSPARENT_EDGES | HIGHLIGHTED_EDGES | XRAYED_EDGES | SELECTED_EDGES
    // renderPass = OPAQUE_EDGES | TRANSPARENT_EDGES | HIGHLIGHTED_EDGES | XRAYED_EDGES | SELECTED_EDGES
